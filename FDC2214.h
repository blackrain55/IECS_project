...
#define FDC_IIC_SDA    PCout(5)   //Output SDA
#define FDC_READ_SDA   PCin(5)         //Enter SDA

/*FDC2214 IIC from the address
 *ADDR = L , I2C Address = 0x2A
 *ADDR = H , I2C Address = 0x2B*/
#define FDC2214_ADDR 0x2A

/*FDC2214 Each register address*/
#define DATA_CH0 0x00                     //Data register
...
#define CLOCK_DIVIDERS_C_CH0 0x14       //Clock division
#define CLOCK_DIVIDERS_C_CH1 0x15
#define CLOCK_DIVIDERS_C_CH2 0x16
#define CLOCK_DIVIDERS_C_CH3 0x17
#define STATUS 0x18                     //Status register
#define ERROR_CONFIG 0x19                 //Error report setting
#define CONFIG 0x1A
#define MUX_CONFIG 0x1B
#define RESET_DEV 0x1C
#define DRIVE_CURRENT_CH0 0x1E          //Current drive
#define DRIVE_CURRENT_CH1 0x1F
#define DRIVE_CURRENT_CH2 0x20
#define DRIVE_CURRENT_CH3 0x21
#define MANUFACTURER_ID 0x7E      //Read value: 0x5449
#define DEVICE_ID 0x7F            //Read value: 0x3055
